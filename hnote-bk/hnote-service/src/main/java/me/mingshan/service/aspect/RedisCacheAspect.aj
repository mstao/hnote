package me.mingshan.service.aspect;
 ...
 *
 * @Author: mingshan
 * @Date: Created in 19:45 2018/6/6
 */
@Aspect
@Component
public class RedisCacheAspect {
     ...
     * @throws Throwable
     */
    @Around("execution(* me.mingshan.service.impl..*Impl.select*(..))" +
            "|| execution(* me.mingshan.service.impl..*Impl.get*(..))" +
            "|| execution(* me.mingshan.service.impl..*Impl.find*(..))" +
            "|| execution(* me.mingshan.service.impl..*Impl.search*(..))")
